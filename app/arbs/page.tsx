                  ...
                  {rows.map((row, i) => (
                    <tr key={i} className={`border-t border-gray-100 ${i % 2 === 0 ? "bg-white" : "bg-gray-50"}`}>
                      ...
                      <td className="px-1 py-1">
                        <select value={row.carpable} onChange={(e) => updateRow(i, "carpable", e.target.value)}
                      ...
                      <td className="px-1 py-1">
                        <select value={row.eligibility} onChange={(e) => updateRow(i, "eligibility", e.target.value)}
                      ...
                      <td className="px-1 py-1">
                        <input type="text" value={row.date_distributed} onChange={(e) => updateRow(i, "date_distributed", e.target.value)}
                          placeholder="mm/dd/yyyy"
                          disabled={!row.date_encoded?.trim()}
