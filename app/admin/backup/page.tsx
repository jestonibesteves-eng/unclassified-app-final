                        ...
                        <td className="px-4 py-2.5 whitespace-nowrap">
                          {b.b2Upload === undefined ? (
                            ...
                            <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded text-[10px] font-semibold bg-green-50 text-green-700">
                              <svg width="10" height="12" viewBox="0 0 50 62" fill="none" aria-hidden="true">
                                <path d="M25 0C16 11 10 20 10 30a15 15 0 0 0 30 0C40 20 34 11 25 0z" fill="#E05A14"/>
                                <path d="M25 18c-4 7-7 13-7 18a7 7 0 0 0 14 0C32 31 29 25 25 18z" fill="#fff"/>
                              </svg>
                              Uploaded
                            </span>
                          ) : (
